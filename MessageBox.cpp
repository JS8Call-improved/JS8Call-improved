                                    ...
                                    MessageBox::StandardButton default_button)
{
    ...
    while (mask <= MessageBox::LastButton) {
        ...
        if ((default_button == MessageBox::NoButton
            ...
            || (default_button != MessageBox::NoButton && sb == static_cast<uint>(default_button)))
...
auto MessageBox::information_message(QWidget* parent,
                                     QString const& text,
                                     QString const& informative,
                                     QString const& detail,
                                     StandardButtons buttons,
...
auto MessageBox::query_message(QWidget* parent,
                               QString const& text,
                               QString const& informative,
                               QString const& detail,
                               StandardButtons buttons,
...
auto MessageBox::warning_message(QWidget* parent,
                                 QString const& text,
                                 QString const& informative,
                                 QString const& detail,
                                 StandardButtons buttons,
...
auto MessageBox::critical_message(QWidget* parent,
                                  QString const& text,
                                  QString const& informative,
                                  QString const& detail,
                                  StandardButtons buttons,
