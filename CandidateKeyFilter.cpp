...
CandidateKeyFilter::CandidateKeyFilter(QAbstractItemModel* referenced_model,
                                       ...
                                       int referencing_key_role) :
    QSortFilterProxyModel { parent },
    m_ { referenced_key_column,
         referenced_key_role,
         referencing_model,
         referencing_key_column,
...
bool CandidateKeyFilter::filterAcceptsRow(int candidate_row,
                                          QModelIndex const& candidate_parent) const
{
    ...
    auto candidate_key = sourceModel()
