...
TraceFile::impl::impl(QString const& trace_file_path) :
    file_ { trace_file_path }, original_stream_ { current_stream_ }, original_handler_ { nullptr }
{
                                      ...
                                      QString const& msg)
{
    ...
    default: severity = "Critical"; break;
    }

    {
        ...
        *current_stream_ << QDateTime::currentDateTimeUtc().toString("yyyy-MM-ddTHH:mm:ss.zzzZ")
                         << '(' << context.file << ':'
