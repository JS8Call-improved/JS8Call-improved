...
public:
    ...
    */
    ...
    static QList<QPair<int, QVector<bool>>> huffEncode(const QMap<QString, QString>& huff,
                                                       QString const& text);
    ...
    static QStringList
        unpackHeartbeatMessage(const QString& text, quint8* pType, bool* isAlt, quint8* pBits3);
    ...
    static QString
        packCompoundFrame(const QString& callsign, quint8 type, quint16 num, quint8 bits3);
    static QStringList
        unpackCompoundFrame(const QString& text, quint8* pType, quint16* pNum, quint8* pBits3);
