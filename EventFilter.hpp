...
public:
    ...
    FocusOut(Filter filter, QObject* parent = nullptr) : QObject { parent }, filter_ { filter } { }
...
public:
    ...
    EnterKeyPress(Filter filter, QObject* parent = nullptr) : QObject { parent }, filter_ { filter }
    {
    }
