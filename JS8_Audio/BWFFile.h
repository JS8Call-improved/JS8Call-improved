...
public:
    ...
    explicit BWFFile(QAudioFormat const&, QString const& name, QObject* parent = nullptr);
    ...
    // ordering.
    //
    explicit BWFFile(QAudioFormat const&,
                     QString const& name,
                     InfoDictionary const&,
    ...
    // is modified.
    //
    enum class BextVersion : quint16
    {
        v_0,
        v_1,
        v_2
