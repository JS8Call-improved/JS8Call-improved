 ...
 *
 *          <magic-number><schema-number><type><id><32-bit-count>  # binary
 * encoded fields # the remainder is the contents of the ADIF text field
 *          <adif_ver:5>3.0.7
 *          <programid:6>WSJT-X
 *          <EOH>
 ...
 *
 *      Invalid or  unrecognized values  will be silently ignored. A sort-order
 * of ffffffff will remove the sort-order value from the internal table.
 *      Callsigns without a sort order will be valued at zero for sorting
