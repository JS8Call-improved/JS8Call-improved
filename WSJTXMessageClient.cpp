...
void WSJTXMessageClient::impl::set_server (QString const& server_name, QStringList const& network_interface_names)
{
...
void WSJTXMessageClient::impl::send_message (QByteArray const& message, bool queue_if_pending, bool allow_duplicates)
{
  if (server_port_)
    {
      if (!server_.isNull ())
...
WSJTXMessageClient::WSJTXMessageClient (QString const& id, QString const& version, QString const& revision,
...
void WSJTXMessageClient::set_server (QString const& server_name, QStringList const& network_interface_names)
{
  m_->set_server (server_name, network_interface_names);
}
