...
#define ENUM_CONVERSION_OPS_DECL(CLASS, ENUM) QString enum_to_qstring(CLASS::ENUM const&);
...
#define ENUM_QDEBUG_OPS_DECL(CLASS, ENUM) QDebug operator<<(QDebug, CLASS::ENUM const&);
...
public:
    ...
    static QVariant asQVariant(T* ptr) { return QVariant::fromValue(reinterpret_cast<void*>(ptr)); }
};
