...
CAboutDlg::CAboutDlg(QWidget* parent) : QDialog(parent), ui(new Ui::CAboutDlg)
{
    ...
    ui->labelTxt->setText(QString {
        ...
        "<p>It is the result of a team that continued development of js8call and added further "
        "improvements.<br />This team includes: <br />Chris AC9KH, Allan W6BAZ, Wyatt KJ4CTD, Joe "
        "K0OG, Andreas DJ3EI, Rob Ruchte K4RWR.</p>"
        "<p>The JS8Call-improved code lives in "
        "<a "
        "href=\"https://github.com/JS8Call-improved/JS8Call-improved\">https://github.com/"
        "JS8Call-improved/JS8Call-improved</a> .</p>"
        ...
        "bring JS8Call into the world.</p>" }
                              .arg(program_title()));
}
